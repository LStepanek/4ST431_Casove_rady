...
\usepackage{listings}
\usepackage{titleps}
\usepackage{titling}    % vytvoří líbivou titulní stránku
\usepackage{subfig}
\usepackage{tikz}
...
\pretitle{%
	...
	\includegraphics[
		width = 0.20\textwidth
	]{VSElogo_modre_kulate_CZ.eps} \\ [1.5cm]
	...
	%% autor ------------------------------------------------------------------
	\noindent
	{\Large $\longeq$ 4ST431 Časové řady $\longeq$} \\ [0.5cm]
	{\Large $\longeq$ semestrální práce $\longeq$} \\ [2.5cm]
